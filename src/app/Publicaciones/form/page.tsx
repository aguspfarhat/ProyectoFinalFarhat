...
//                 titulo,
//                 descripcion,
//                 imagen: reader.result as string, // Imagen en formato Base64
//             };
...
//     const [imagen, setImagen] = useState<File | null>(null);
//     const [publicaciones, setPublicaciones] = useState<Publicacion[]>([]);
//     const [publicacionSeleccionada, setPublicacionSeleccionada] = useState<Publicacion | null>(null); // Estado para controlar la publicación seleccionada
